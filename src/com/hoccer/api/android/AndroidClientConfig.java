...
public class AndroidClientConfig extends ClientConfig {
    ...
    public AndroidClientConfig(String applicatioName, String apiKey, String sharedSecret, UUID clientId,
            String clientName, String publicKey) {

        super(applicatioName, apiKey, sharedSecret, clientId, clientName, publicKey);
    }

    public AndroidClientConfig(String applicatioName, String apiKey, String sharedSecret) {

        super(applicatioName, apiKey, sharedSecret);
    }

    public AndroidClientConfig(String applicatioName, UUID clientId, String clientName) {
